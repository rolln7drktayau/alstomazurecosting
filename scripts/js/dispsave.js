...
var cart = new Cart();
var pack = new Machine();
var ans = "";

var pack_cpt = cart.machines.length;
var disk_cpt = 0;
var tb_cpt = 0;
...
function pushIn() {
    ...
    // To increase
    disk_cpt = pack.managedDisks.length;
...
function createEmptyTable(cpt) {
    // let out = "";
    let empT = '<tbody id="body-'+ cpt +'"> <tr id="tb' +
